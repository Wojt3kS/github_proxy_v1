...
class GitHubResponseParserTest {
    ...
    void parseUserResponseToRepositoriesNamesList() {
        ...
        Reader stringReader = new StringReader(responseToParse);
        List<String> expectedResult = Arrays.asList("SolMan");
        List<String> wrongResult = Arrays.asList("SolMan", "Koza");
        List<String> result = gitHubResponseParser.parseUserResponseToRepositoriesNamesList(stringReader);
    ...
    void parseRepositoriesResponseToRepository() {
        ...
        Repository result = gitHubResponseParser.parseRepositoriesResponseToRepository(stringReader, "basegrid");
        assertEquals(expectedResult, result);
    }
}