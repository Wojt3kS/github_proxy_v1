...
class GitHubConnectorTest {
    ...
    @Test
    void sendGetGithubUserRequestWithEmptyUser() throws IOException {
        Response response = gitHubConnector.sendGetGithubUserRequest("");
        assertEquals(404, response.code());
    }

    @Test
    void sendGetGithubUserRequestWithExistingUser() throws IOException {
        Response response = gitHubConnector.sendGetGithubUserRequest("Stefan");
    ...
    @Test
    void sendGetGithubBranchListRequestWithEmptyUserAndRepository() throws IOException {
        Response response = gitHubConnector.sendGetGithubBranchListRequest("", "");
        assertEquals(404, response.code());
    }

    @Test
    void sendGetGithubBranchListRequestWithExistingUserAndRepository() throws IOException {
        Response response = gitHubConnector.sendGetGithubBranchListRequest("okydk", "basegrid");
